...
public:
    ...
    NETVAR(int, m_iIDEntIndex, "C_CSPlayerPawn", "m_iIDEntIndex");
    NETVAR(Vector, m_pGlowServices, "C_CSPlayerPawn", "m_pGlowServices");
    NETVAR(QAngle, m_aimPunchAngle_REMOVED, "C_CSPlayerPawn", "m_aimPunchAngle");
    ...
    NETVAR(QAngle, m_angEyeAngles, "C_CSPlayerPawn", "m_angEyeAngles");
    NETVAR(QAngle, v_angle, "C_BasePlayerPawn", "v_angle");
    NETVAR(CUtlVector<QAngle>, m_aimPunchCache_REMOVED, "C_CSPlayerPawn", "m_aimPunchCache");
    NETVAR(bool, m_bIsScoped, "C_CSPlayerPawn", "m_bIsScoped");
    NETVAR(bool, m_bGunGameImmunity, "C_CSPlayerPawn", "m_bGunGameImmunity");
    NETVAR(CPlayer_ObserverServices*, m_pObserverServices, "C_BasePlayerPawn", "m_pObserverServices")
    NETVAR(CCSPlayer_ViewModelServices*, m_pViewModelServices_REMOVED, "C_CSPlayerPawnBase", "m_pViewModelServices")
